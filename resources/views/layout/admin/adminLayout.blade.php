...
<body id="kt_body"
                            ...
                            <div data-kt-swapper="true"
                                ...
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">
                                    ...
                                    @hasSection('page_subtitle')
                                        ...
                                        <span class="text-muted fs-7 fw-bold mt-2">@yield('page_subtitle')</span>
                                    @endif
                                </h1>
    ...
    @include('components.admin.common.drawer')

    <!--end::Main-->

    @include('components.admin.common.scrolltop')
